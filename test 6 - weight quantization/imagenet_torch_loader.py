...
def conversion_to_analog(model_to_convert):
    ...
    #rpu_config.forward.inp_res = -1.  # Turn off (input) DAC discretization.
    
    rpu_config.forward.out_res = 4.  # Change (output) ADC discretization.
    rpu_config.forward.inp_res = 4.  # Change (input) DAC discretization.
...
parser.add_argument('--data_dir', type=str, default='/home/elinor/Downloads/imagenet-object-localization-challenge/imagenet_object_localization_patched2019/ILSVRC/Data/CLS-LOC/')
...
def main_worker(gpu, ngpus_per_node, cfg):
    ...
    model = conversion_to_analog(model)
    
    print('===> Finished conversion to analog')
