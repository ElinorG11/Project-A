...
def conversion_to_analog(model_to_convert):
    ...
    program_analog_weights(net) # can also omitted as it is called below in any case
    drift_analog_weights(net, t_inference) # modifies weights according to noise model
...
if __name__ == '__main__':
    ...
    plot_statistics_by_layer_size('RESNET18',stat,layers_sizes)
