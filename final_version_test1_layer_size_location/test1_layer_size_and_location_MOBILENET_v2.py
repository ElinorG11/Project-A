...
if __name__ == '__main__':
    ...
    checkpoint = torch.load("/home/elinor/aihwkit/to_analog_backup/trained weights/weights_mobilenet.pth")
    ...
    for name, layer in model.named_children():
      ...
      if isinstance(layer, nn.Sequential):
        for block in layer:
          ...
          layer_structure.append("(" + str(c1.in_channels)  + ", " + str(c1.kernel_size[0]) + "x" + str(c1.kernel_size[1]) + ")")
          ...
          layer_structure.append("(" + str(c2.in_channels)  + ", " + str(c2.kernel_size[0]) + "x" + str(c2.kernel_size[1]) + ")")
