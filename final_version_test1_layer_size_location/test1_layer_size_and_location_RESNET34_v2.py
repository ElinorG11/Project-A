...
def conversion_to_analog(model_to_convert):
    ...
    #ideal_weights = copy.deepcopy(model_to_convert.weight)
    #print(ideal_weights)
    ...
    cond_weights, scale = add_noises(ideal_weights)

    t_inference = 3600
    Gdrift, ReadNoise = pcm_noise.ReadWithNoise(weights_ideal, t_inference)
    weights = (Gdrift + ReadNoise)/scale
    analog_conv_uni.weight = torch.nn.Parameter(weights)
    """
...
#model = torch.load("/home/elinor/aihwkit/to_analog_backup/resnet34-cifar10-pytorch/checkpoint/weights_resnet34.pth")


"""
for key in model.keys():
  if key.find('weight') != -1:
    weights_ideal.append(model[key])
"""
...
if __name__ == '__main__':
    ...
    checkpoint = torch.load("/home/elinor/aihwkit/to_analog_backup/resnet34-cifar10-pytorch/checkpoint/weights_resnet34.pth")
    ...
    plot_statistics_by_layer_size('RESNET34',stat,layers_sizes,layer_structure)
